...
VALUES
    (
        '79fd3225-bfa7-404d-a233-3a73b27cefa4',
    ...
    (
        ...
        'Design Patterns',
        'A book that introduced the concept of software design patterns.',
    ...
    (
        ...
        'Refactoring',
        'Techniques for improving code quality and structure.',
    ...
    (
        ...
        'Essays on software engineering and project management.',
    ...
    (
        ...
        'Take a strategic approach to software construction—and produce superior products—with this fully updated edition of Steve McConnell'' s critically praised
        and award - winning guide to software development best practices.Widely considered one of the best practical guides to programming,
    ...
    (
        ...
        'Exploring the best features of JavaScript.',
